...
(function() {
  ...
  ColumnConfiguration = (function() {
    ...
    ColumnConfiguration.prototype.renderSorting = function(element) {
      ...
      if (this.sortable) {
        ...
        icon = angular.element("<br><span style='margin-left: 10px; cursor:pointer;' class='glyphicon glyphicon-sort' aria-hidden='true' ></span>");
    ...
    ColumnConfiguration.prototype.renderWidth = function(element) {
      //alert('ColumnConfiguration.prototype.renderWidth:' + this.width);
  ...
  TableConfiguration = (function() {
    ...
    TableConfiguration.prototype.collectBodyMarkup = function(table) {
      var attribute, state, bodyDefinition, initialSorting, sortable, td, title, width, _i, _len, _ref;
      bodyDefinition = [];
      _ref = table.find("td");
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        td = _ref[_i];
  ...
  angular.module("angular-table").directive("atImg", [
    function() {
      return {
        restrict: "AC",
        compile: function(element, attributes, transclude) {
          var attribute;
          attribute = element.attr("at-attribute");
          var state = element.attr("at-state");
          if (!attribute) {
            throw "at-implicit specified without at-attribute: " + (element.html());
          }
          return element.append("<a ui-sref='products."+state+".spec({ "+state+"Id: item.id })'><div > <img img-preload class='fade' ng-src='{{item." + attribute + "}}'></div></a>");
  ...
  angular.module("angular-table").directive("atDownload", [
    function() {
      return {
        restrict: "AC",
        compile: function(element, attributes, transclude) {
          ...
          return element.append("<a target='_blank' href='{{item." + attribute + "}}'>Download</a>");
